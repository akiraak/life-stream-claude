...
- [x] Phase 4: 動作確認 / 微調整
  - [x] 短いプラン / 長いプラン / Mermaid を含むプランで表示確認
  - [x] 狭い幅（〜900px 程度）でレイアウト崩れがないか確認
  - [x] アーカイブボタンの位置・動作が変わっていないこと
- [x] Phase 5: 後片付け
  - [x] `TODO.md` の該当項目を `DONE.md` に移動
  - [x] 本プランファイルを `docs/plans/archive/` に移動
