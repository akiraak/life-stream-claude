...
const Pages = {
  ...
  'native-app':       { title: 'ネイティブアプリ技術検討', render: renderNativeApp },
  'remote-dev':       { title: 'リモート開発環境検討', render: renderRemoteDev },
  'react-native-plan': { title: 'React Native 開発計画', render: renderReactNativePlan },
};
